                    ...
                    <div class="tab-pane active fade in" id="all-tasks">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title" id="test"><i class="icon-paragraph-justify2"></i>Task List</h6> <span class="pull-right label label-danger"><?php echo count($result); ?></span> </div>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="task-progress">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
...
?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $r->description; ?> </td>
                                        ...
                                        <td> <?php if($r->status == '0'){ echo "Incomplete"; } else{ echo "Complete"; } ?> </td>
                                        <?php if($r->status == '0'){ ?>
