...
<html lang="en">
    ...
    <body class="full-width page-condensed">
        ...
        <div class="login-wrapper"> 
            <form action="<?=site_url('employee/login/process');?>" method="post" role="form">
                ...
                <div class="well">
                    ...
                    <div class="form-group has-feedback"><label>Password</label>
                        <input type="password" name="userpass" class="form-control" placeholder="Password"><i class="icon-lock form-control-feedback"></i>
                    </div>
