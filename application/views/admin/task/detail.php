                        ...
                        <div class="panel-footer">
                            <div class="pull-left">
                                <ul class="footer-links-group">
                                    ...
                                    <li><i class="icon-user muted"></i> Assigned User: <a href="#" class="text-semibold">
                                        <?php echo  $this->db->get_where('users', array('id'=>$result->user_id))->row()->name; ?>
                                    </a></li>
...
?> -->
                    ...
                    <div class="block">
                        ...
                        <div class="well">
                            <form action="<?php echo site_url('admin/task/comment/'.$result->id); ?>" role="form" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Action</label>
                            <select name="action" class="form-select form-select-lg mb-3t">
                                <option value="1">OK</option>
                                <option value="0">REDO</option>
                            </select>
                            </div>
                                <div class="form-group">
                                    <label>Comment: </label>
